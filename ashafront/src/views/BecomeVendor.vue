<template>
    <main class="main">
        ...
        <nav class="breadcrumb-nav mb-5 mt-5 pb-lg-10">
            <div class="container">
                <ul class="breadcrumb">
        ...
        <div class="page-content become-a-vendor">
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <figure class="br-sm">
                                <img src="../assets/images/pages/become/1.jpg" alt="Banner" width="610" height="435" style="background-color: #D9D8DD;">
                            </figure>
                        </div>
                        <div class="col-md-6 order-md-first">
                            <h4 class="text-primary font-weight-bold ls-25">Create a Store</h4>
                            <h2 class="title text-left">Build your online store on Asha</h2>
                    ...
                    <div class="row">
                        <div class="col-sm-6 listing-fee">
                            <div class="counter text-center">
                                <span>$</span>
                                <span class="count-to complete" data-to="0">0</span>
                                <h4>Listing Fee</h4>
                        ...
                        <div class="col-sm-6 final-fee">
                            <div class="counter text-center">
                                <span class="count-to complete" data-to="5">5</span>
                                <span>%</span>
                ...
                <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}" data-image-src="../assets/images/pages/become/3.jpg" style="background-color: rgb(146, 146, 148); position: relative; overflow: hidden;"><div class="parallax-background" style="background-image: url(&quot;assets/images/pages/become/3.jpg&quot;); background-size: cover; position: absolute; top: 0px; left: 0px; width: 100%; height: 200%; transform: translate3d(0px, -410.166px, 0px); background-position-x: 50%;"></div>
                    <div class="container">
                        <div class="banner-content text-center">
                            <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can make
                                    brands work for you</h2>

                            <router-link :to="{name:'vendorSignUp'}" class="btn btn-white btn-outline btn-rounded ls-25">Register Now</router-link>
                        </div>
                    </div>
                </div>
            </div>
