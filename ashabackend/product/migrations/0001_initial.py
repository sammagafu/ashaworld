    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coverImage', models.ImageField(upload_to='product/cover/%Y/%m/%d', verbose_name='cover Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.ImageField(upload_to='product/images/%Y/%m/%d', verbose_name='Other Product Images')),
